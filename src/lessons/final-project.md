...
<!--meta studentInstructionsLink: https://github.com/kiboschool/programming2-final-project -->
<!--meta topics: oop, inheritance, testing, refactoring -->

# Final Project: Competition CLI

## Obtain the Starter Code

[![chatbot](https://img.shields.io/static/v1?label=Begin%20Project&message=EventBrite%20Competition%20CLI&color=blue)](https://github.com/kiboschool/programming2-final-project)
